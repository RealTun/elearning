...
const Dashboard = () => {
  ...
  return (
    <div className="dashboard">
      {/* Phần header */}
      <Header 
        username="HuongPTA" //truyền username
        title="Tổng quan"
        ...
        <div className="dashboard-main-content-left col-md-8">
          ...
          <div className="row mb-3">
            <div className="col-md-4">
              <InfoCard
                icon={<i class="fas fa-book" style={{ color: "#569AE3" }}></i>}
                title="Đang học"
                value={5}
                bgColor="bg-blue"
              />
            ...
            <div className="col-md-4 mb-3">
              <InfoCard
                icon={<i class="fas fa-award" style={{color: "#FDAB5F"}}></i>}
        ...
        <div className="main-contain-right col-md-4 px-5">
          ...
          <div className="listschedule">
            {[
              ...
              { time: "16:00 PM", label: "Học", title: "Lập trình JavaScript" },
